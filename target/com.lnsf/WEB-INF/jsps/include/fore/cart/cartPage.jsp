...
$(function(){
	...
	$('#deleteConfirmModal').on('hidden.bs.modal', function (e) {
		if(deleteOrderItem){
			var page="${pageContext.request.contextPath }/deleteOrderItem";
			$.post(
					page,
	...
	$("button.createOrderButton").click(function(){
		...
		location.href="${pageContext.request.contextPath }/ordermany?"+params+total;
	});
...
function syncPrice(pid,num,price){
	...
	var page = "${pageContext.request.contextPath }/changenumber";
	$.post(
		    page,
		    {"pid":pid,"number":num},
		    function(result){
				...
				<c:forEach items="${ois}" var="oi">
					<tr oiid="${oi.id}" class="cartProductItemTR">
						<td>
							...
							<img class="cartProductImg"  src="${pageContext.request.contextPath }/${oi.product.productimage.path}">
						</td>
						<td>
							<div class="cartProductLinkOutDiv">
								<a href="foreproduct?pid=${oi.product.pid}" class="cartProductLink">${oi.product.name}</a>
						...
						<td>
							...
							<div class="cartProductChangeNumberDiv">
								<span class="hidden orderItemStock " pid="${oi.product.pid}">${oi.product.stock}</span>
								<span class="hidden orderItemPromotePrice " pid="${oi.product.pid}">${oi.product.promoteprice}</span>
								<a  pid="${oi.product.pid}" class="numberMinus" href="#nowhere">-</a>
								<input pid="${oi.product.pid}" oiid="${oi.id}" class="orderItemNumberSetting" autocomplete="off" value="${oi.number}">
								<a  stock="${oi.product.stock}" pid="${oi.product.pid}" class="numberPlus" href="#nowhere">+</a>
							</div>					
						
						 </td>
						<td >
							<span class="cartProductItemSmallSumPrice" oiid="${oi.id}" pid="${oi.product.pid}" >
