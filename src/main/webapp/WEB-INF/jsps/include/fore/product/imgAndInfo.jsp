                ...
                function(result){
                    if("success"==result){
                        ...
                        var addCartpage = "${pageContext.request.contextPath }/foreaddCart";
                          $.ajax({
                                data: {id:"",pid:pid,oid:"",uid:uid,number:number},
                                type:'post',
                                datatype:'text',
                                url:addCartpage,
...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="${pageContext.request.contextPath}/${p.productimage.path}" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${type_single}" var="pi">
                <img src="${pageContext.request.contextPath}/${pi.path}" bigImageURL="${pageContext.request.contextPath}/${pi.path}" class="smallImage">
            </c:forEach>
        </div>
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="buyDiv">
            <a class="buyLink" href="${pageContext.request.contextPath}/orderone?pid=${p.pid}"><button class="buyButton">立即购买</button></a>
