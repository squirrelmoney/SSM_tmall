<%--
  购买页面：session(用session传要购买的商品)+jq+css
...
<div class="buyPageDiv">
  <form action="${pageContext.request.contextPath}/comfirmOrder" method="post">
			...
			<tbody class="productListTableTbody">
				<c:forEach items="${orderitems}" var="oi" varStatus="st" >
					...
					<tr class="orderItemTR">
						<td class="orderItemFirstTD"><img class="orderItemImg" src="${pageContext.request.contextPath}/${oi.product.productimage.path}"></td>
						<td class="orderItemProductInfo">
						<a  href="foreproduct?pid=${oi.product.pid}" class="orderItemProductLink">
							${oi.product.name}
						</a>
