...
<div class="confirmPayPageDiv">
	...
	<div class="confirmPayOrderItemDiv">
		...
		<table class="confirmPayOrderItemTable">
			...
			<c:forEach items="${o.orderitems}" var="oi">
				<tr>
					<td><img width="50px" src="${pageContext.request.contextPath}/${oi.product.productimage.path}"></td>
	...
	<div class="confirmPayButtonDiv">
		<div class="confirmPayWarning">请收到货后，再确认['收货！否则您可能钱货两空！</div>
		<a href="${pageContext.request.contextPath}/orderconfirmed?oid=${o.oid}"><button class="confirmPayButton">确认收货</button></a>
	</div>
</div>